...
public class IOTDashboard {
	...
	public static void main(String[] args) {
		...
		BigDecimal lsValue = lightSwitch.calculateValue(lightSwitch.cost, lightSwitch.getInstallDate(), LocalDate.now());
		BigDecimal phillipsValue = lightSwitch.calculateValue(phillipsLightSwitch.cost, phillipsLightSwitch.getInstallDate(), LocalDate.now());
